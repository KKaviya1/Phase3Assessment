...
namespace EMSFullStackApp.Controllers
{
    ...
    {
        private readonly SimplonaDbContext _context;

        public EmpProfilesController(SimplonaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'SimplonaDbContext.EmpProfile'  is null.");
          }
